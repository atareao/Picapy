...
class Preferences(Gtk.Dialog):
	def __init__(self,parent):
		...
		#vbox0.pack_start(frame0,False,False)
		#
		...
		table.attach(label11,0,1,0,1, xoptions = Gtk.AttachOptions.FILL, yoptions = Gtk.AttachOptions.SHRINK)
		#
		...
		self.checkbutton21 = Gtk.CheckButton.new_with_label(_('Reduce size to')+':')
		...
		#
		self.checkbutton22 = Gtk.CheckButton.new_with_label(_('Gray scale')+':')
		...
		self.entry_slideshow.set_adjustment(Gtk.Adjustment(value=0,lower=1,upper=1000,step_increment=1,page_increment=10,page_size=10))
