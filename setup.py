...
DATA_FILES=[
	('/opt/extras.ubuntu.com/picapy/bin', ['bin/picapy']),
	('/usr/share/applications', ['data/extras-picapy.desktop']),
	('/opt/extras.ubuntu.com/picapy/share/picapy', glob.glob('data/icons/*')),	
	('/opt/extras.ubuntu.com/picapy/share/picapy', glob.glob('src/*')),	
	('/opt/extras.ubuntu.com/picapy/share/picapy',['debian/changelog']),		
	]
...
class install_data(_install_data):
	def run(self):
		for lang in os.listdir('build/locale-langpack/'):
			lang_dir = os.path.join('/opt/extras.ubuntu.com/picapy/share', 'locale-langpack', lang, 'LC_MESSAGES')
